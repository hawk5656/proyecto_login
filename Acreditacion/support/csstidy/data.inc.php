 ...
 *
 * Initialization data for CSSTidy.
 *
...
define('CSSTIDY_AT_START',     1);
define('CSSTIDY_AT_END',       2);
define('CSSTIDY_SEL_START',    3);
define('CSSTIDY_SEL_END',      4);
define('CSSTIDY_PROPERTY',     5);
define('CSSTIDY_VALUE',        6);
define('CSSTIDY_COMMENT',      7);
define('CSSTIDY_SEL_SEPARATE', 8);
define('CSSTIDY_DEFAULT_AT',  41);
 ...
 *
 * @global array $GLOBALS['csstidy']['templates']
 * @version 1.4
 */
$GLOBALS['csstidy']['templates'] = array();

$files = glob(realpath(dirname(__FILE__)) . '/templates/*.php');
