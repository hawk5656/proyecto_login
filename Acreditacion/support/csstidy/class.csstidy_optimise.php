...
class csstidy_optimise
{
	...
	function csstidy_optimise(&$css)
	{
		...
		$this->sel_separate  =& $css->sel_separate;
	...
	function shorthands()
	{
		...
		if($this->property === 'font' && $this->parser->get_cfg('optimise_shorthands') > 0)
		{
			...
			$this->parser->merge_css_blocks($this->at,$this->selector,$this->sel_separate,csstidy_optimise::dissolve_short_font($this->value));
		}
		if($this->property === 'background' && $this->parser->get_cfg('optimise_shorthands') > 1)
		{
			unset($this->css[$this->at][$this->selector]['background']);
			$this->parser->merge_css_blocks($this->at,$this->selector,$this->sel_separate,csstidy_optimise::dissolve_short_bg($this->value));
		}
		if(isset($shorthands[$this->property]))
		{
			$this->parser->merge_css_blocks($this->at,$this->selector,$this->sel_separate,csstidy_optimise::dissolve_4value_shorthands($this->property,$this->value));
